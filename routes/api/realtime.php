...
use App\Http\Controllers\Api\Realtime\LegacyCallerEventUsageController;
...
Route::middleware(['auth', 'role:citizen,operator'])->post('/realtime/legacy-caller-events', [LegacyCallerEventUsageController::class, 'store']);
