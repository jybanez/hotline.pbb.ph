...
class SitrepMediaController extends Controller
{
    ...
    private function resolveMessageAttachment(array $ref, bool $includeDownloadUrl): array
    {
        ...
        $item = [
            ...
            'stored_mime_type' => $this->text($attachment->stored_mime_type),
            ...
            'sha256' => $this->text($attachment->sha256),
            'normalized_at' => $attachment->normalized_at?->toIso8601String(),
            'file_size' => (int) ($attachment->stored_size_bytes ?? $attachment->file_size),
