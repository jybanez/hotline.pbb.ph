    ...
    return {
        ...
        sections: [
            ...
            },
            {
                ...
                title: 'Account',
                description: 'Account SSO and service-only app-admin runtime controls. Account and Kit own trusted-client registration details.',
                properties: [
                    {
                    ...
                    },
                    {
                        ...
                        kind: 'password',
                        label: 'Account OAuth Secret',
                        value: values.account_sso_client_secret ?? '',
                        placeholder: 'Enter Account OAuth client secret',
                        autocomplete: 'off',
                        help: 'OAuth client secret used during Account token exchange. Use the password reveal control only when visually verifying against a trusted copy.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        autocomplete: 'off',
                        help: 'Expected X-PBB-Account-Client header value for Account service calls. Keep aligned with Account provisioning.',
                    },
                    {
