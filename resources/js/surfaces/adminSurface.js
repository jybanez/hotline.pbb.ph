        ...
        sections: [
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        value: values.realtime_client_code ?? 'clt_PBB_HOTLINE',
                        placeholder: 'clt_PBB_HOTLINE',
                        autocomplete: 'off',
                    ...
                    },
                    {
                        ...
                        value: values.realtime_project_code_server ?? 'prj_HOTLINE_SERVER',
                        placeholder: 'prj_HOTLINE_SERVER',
                        autocomplete: 'off',
                    ...
                    },
                    {
                        ...
                        value: values.realtime_project_code_caller ?? 'prj_HOTLINE_CITIZEN',
                        placeholder: 'prj_HOTLINE_CITIZEN',
                        autocomplete: 'off',
                    ...
                    },
                    {
                        ...
                        value: values.realtime_project_code_operator ?? 'prj_HOTLINE_OPERATOR',
                        placeholder: 'prj_HOTLINE_OPERATOR',
                        autocomplete: 'off',
                    ...
                    },
                    {
                        ...
                        value: values.realtime_project_code_media_ingest ?? 'prj_HOTLINE_OPERATOR',
                        placeholder: 'prj_HOTLINE_OPERATOR',
                        autocomplete: 'off',
            ...
            },
            {
                ...
                properties: [
                    ...
                    {
                        id: 'relay_source_system',
                        kind: 'text',
                        label: 'Relay Source System',
                        value: values.relay_source_system ?? 'sitrep.app',
                        placeholder: 'sitrep.app',
                        autocomplete: 'off',
                        help: 'Sender system identifier placed in SITREP Relay message envelopes from this Hotline app.',
                    },
                    {
                        id: 'relay_target_systems',
                        kind: 'text',
                        label: 'Relay Target Systems',
                        value: values.relay_target_systems ?? 'sitrep.ingestor',
                        placeholder: 'sitrep.ingestor',
                        autocomplete: 'off',
            ...
            },
            {
                ...
                properties: [
                    {
                        id: 'account_sso_enabled',
                        kind: 'select',
                        label: 'Account SSO',
                        value: isTruthySetting(values.account_sso_enabled) ? 'true' : 'false',
                        options: [
                            { value: 'true', label: 'Enabled' },
                            { value: 'false', label: 'Disabled' },
                        ],
                        help: 'Enables browser sign-in through PBB Account for Hotline users.',
                    },
                    {
                        id: 'account_sso_base_url',
                        kind: 'text',
                        label: 'Account URL',
                        value: values.account_sso_base_url ?? 'https://account.pbb.ph',
                        placeholder: 'https://account.pbb.ph',
                        autocomplete: 'off',
                        help: 'Base URL of the local PBB Account app used for OAuth authorization and logout.',
                    },
                    {
                        id: 'account_sso_client_id',
                        kind: 'text',
                        label: 'Account Client ID',
                        value: values.account_sso_client_id ?? 'pbb-hotline',
                        placeholder: 'pbb-hotline',
                        autocomplete: 'off',
                        help: 'OAuth client identifier registered for Hotline in PBB Account.',
                    },
                    {
                        id: 'account_sso_client_secret',
                        kind: 'password',
                        label: 'Account Client Secret',
                        value: values.account_sso_client_secret ?? '',
                        placeholder: 'Enter Account OAuth client secret',
                        autocomplete: 'off',
                        help: 'OAuth client secret used by Hotline during Account callback token exchange. This is separate from the app-admin API token.',
                    },
                    {
                        id: 'account_sso_redirect_uri',
                        kind: 'text',
                        label: 'Account Redirect URI',
                        value: values.account_sso_redirect_uri ?? 'https://hotline.pbb.ph/auth/account/callback',
                        placeholder: 'https://hotline.pbb.ph/auth/account/callback',
                        autocomplete: 'off',
                        help: 'Callback URI registered for Hotline in PBB Account.',
                    },
                    {
                        id: 'account_sso_post_logout_redirect_uri',
                        kind: 'text',
                        label: 'Account Post-Logout URI',
                        value: values.account_sso_post_logout_redirect_uri ?? 'https://hotline.pbb.ph',
                        placeholder: 'https://hotline.pbb.ph',
                        autocomplete: 'off',
                        help: 'Where Account should send the browser after a shared logout.',
                    },
                    {
                        id: 'account_sso_scopes',
                        kind: 'text',
                        label: 'Account OAuth Scopes',
                        value: values.account_sso_scopes ?? 'openid profile',
                        placeholder: 'openid profile',
                        autocomplete: 'off',
                        help: 'Space- or comma-separated scopes requested from PBB Account.',
                    },
                    {
                        id: 'account_sso_ca_bundle',
                        kind: 'text',
                        label: 'Account CA Bundle',
                        value: values.account_sso_ca_bundle ?? '',
                        placeholder: 'Optional CA bundle path',
                        autocomplete: 'off',
                        help: 'Optional CA bundle path used by PHP cURL when exchanging Account authorization codes.',
                    },
                    {
