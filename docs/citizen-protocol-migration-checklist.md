...
- [~] Monitor legacy caller route usage: local log snapshot on 2026-05-11 shows 454 local legacy route hits, all `POST /api/realtime/admission/caller`, last seen at `2026-05-10 14:39:54`; the 2026-05-11 04:06 live call used `/api/realtime/admission/citizen` and the 04:09 Discarded status update did not increase legacy route telemetry; testing logs also contain expected legacy route coverage hits.
