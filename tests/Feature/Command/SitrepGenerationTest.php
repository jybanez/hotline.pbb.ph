...
class SitrepGenerationTest extends TestCase
{
    ...
    public function test_command_user_can_generate_incident_centered_sitrep_snapshot(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('sitrep.source_snapshot.hub_nodes.0.available', true)
            ->assertJsonPath('sitrep.source_snapshot.hub_nodes.0.snapshot.relay_hub_id', '072217029')
        ...
        $this->assertSame('Guadalupe, CEBU CITY, CEBU', $sourceSnapshot['hub_nodes'][0]['snapshot']['name']);
