...
function buildEnvFile(array $config): string
{
    ...
    $values = [
        ...
        'PBB_ACCOUNT_CLIENT_SECRET' => (string) ($hotline['pbb_account_client_secret'] ?? 'pbb-hotline-dev-secret'),
        'PBB_ACCOUNT_REDIRECT_URI' => rtrim($appUrl, '/').'/auth/account/callback',
        'PBB_ACCOUNT_POST_LOGOUT_REDIRECT_URI' => rtrim($appUrl, '/'),
