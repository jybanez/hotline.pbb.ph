...
function buildEnvFile(array $config): string
{
    ...
    $values = [
        ...
        'HOTLINE_SESSION_COOKIE' => 'pbb-hotline-beta-session',
        'SESSION_PATH' => '/',
    ...
    return [
        [
            ...
            'keys' => [
                ...
                ['name' => 'HOTLINE_SESSION_COOKIE', 'value_source' => 'generated_env.HOTLINE_SESSION_COOKIE', 'required' => true, 'secret' => false],
