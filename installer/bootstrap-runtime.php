...
function hotlineSettingKeys(): array
{
    return [
        ...
        'pbb_account_sso_enabled' => 'account_sso_enabled',
        'pbb_account_base_url' => 'account_sso_base_url',
        'pbb_account_client_id' => 'account_sso_client_id',
        'pbb_account_client_secret' => 'account_sso_client_secret',
        'pbb_account_redirect_uri' => 'account_sso_redirect_uri',
        'pbb_account_post_logout_redirect_uri' => 'account_sso_post_logout_redirect_uri',
        'pbb_account_scopes' => 'account_sso_scopes',
        'pbb_account_ca_bundle' => 'account_sso_ca_bundle',
